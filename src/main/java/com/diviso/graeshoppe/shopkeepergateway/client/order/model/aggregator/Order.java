...
public String toString() {
	return String.format(
			...
			appliedOffers, approvalDetails, paymentMode, customerId, date, allergyNote, acceptOrderId, preOrderDate,
			state, deliveryInfo, email, grandTotal, subTotal, id, orderId, orderLines, paymentRef, status, storeId);
}
