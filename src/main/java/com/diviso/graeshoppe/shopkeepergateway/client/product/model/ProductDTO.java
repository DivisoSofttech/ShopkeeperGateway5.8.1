...
@Pattern(regexp="^(?:[A-Za-z0-9+/]{4})*(?:[A-Za-z0-9+/]{2}==|[A-Za-z0-9+/]{3}=)?$") 
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(brandId, buyPrice, categoryId, discountId, iDPcode, id, image, imageLink, isActive, isAuxilaryItem, isServiceItem, locationId, manufacturerId, maxQuantityLevel, minQuantityLevel, name, reference, sellingPrice, showInCatalogue, sku, storageCost, supplierId, taxCategoryId, unitId);
  }
