...
import com.diviso.graeshoppe.shopkeepergateway.client.store.model.ReplyDTO;
...
import com.diviso.graeshoppe.shopkeepergateway.service.CustomerCommandService;
...
public class CommandResource {
	...
	/*
	 * @PostMapping("/sales") public ResponseEntity<SaleDTO> createSale(@RequestBody
	 * SaleDTO saleDTO) { return saleCommandService.createSale(saleDTO); }
	 * 
	 ...
	 * createTickerLine(@RequestBody TicketLineDTO ticketLineDTO) { //correct mathod
	 * name return saleCommandService.createTickerLine(ticketLineDTO); }
	 * 
	 * @PutMapping("/ticket-lines") public ResponseEntity<TicketLineDTO>
